    ...
    <head>
      ...
      <?php
        ...
        if(isset($_POST['submit'])){
          ...
          $query = "INSERT INTO `events` (name,agenda, presenter, date,time,location,type,desctiption,goal, contact, facebook,twitter,linkedin,equipments) 
          VALUES ('$name','$agenda', '$presenter', '$date','$time','$location','$type','$description','$goal', '$contact', '$facebook','$twitter','$linkedin','$equipments')";
...
<div class="modal-dialog" style="width:1137px;">
<div class="modal-content">
  ...
  <div class="modal-body modalbody" style="padding: 0px 122px;">
    ...
    <br>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="class_name"><b>Event Description</b></label>
              <input type="text" class="form-control required" id="text" autocomplete="off" placeholder="Example: Robotics Workshop " id="field" name="description">
            </div>

            <div class="form-group">
              <label for="class_name"><b>Event Goal</b></label>
              <input type="text" class="form-control required" id="text1" autocomplete="off" placeholder="Example: Maximize Performance " id="field" name="goal">
            </div>



            <div class="form-group">
              <label for="class_name"><b>Contact</b></label>
              <input type="tel" class="form-control required" id="text1" autocomplete="off" placeholder="Example: 9771823804 " id="field" name="contact">
            </div>

            <div class="form-group">
              <label for="class_name"><b>Facebook</b></label>
              <input type="text" class="form-control required" id="text1" autocomplete="off" placeholder="Example: Shubhamsahaninitkkr@gmail.com " id="field" name="facebook">
            </div>

            <div class="form-group">
              <label for="class_name"><b>Twitter</b></label>
              <input type="text" class="form-control required" id="text1" autocomplete="off" placeholder="Example: Shubhamsahaninitkkr@gmail.com " id="field" name="twitter">
            </div>

            <div class="form-group">
              <label for="class_name"><b>Linkedin</b></label>
              <input type="text" class="form-control required" id="text1" autocomplete="off" placeholder="Example: Shubhamsahaninitkkr@gmail.com " id="field" name="linkedin">
            </div>

            <div class="form-group">
              <label for="class_name"><b>Equipments</b></label>
              <input type="text" class="form-control required" id="text1" autocomplete="off" placeholder="Example: Mics,Tables " id="field" name="equipments">
            </div>

          </div>
          <button type="button submit_buttons submit" class="btn btn-default submit_buttons" style="text-align:center" data-disiss="modal" class="close" name="submit">Create Event</button>
