      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav navbar-right">
            <a href="#tab-wrong-vehicle"  data-toggle="modal" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='white'"data-target="#buyers-report-modal" style="
    margin-right: 149px;">Log in</a>
  ...
  <div class="container-fluid" style="margin-right: 35px; margin-left: 35px; margin-bottom: 65px;">
    <div class="row"><!--1st row start-->
      ...
      <div class="col-sm-4 col-md-6 content1">
        <p class="heading">Robotics Workshop </p><span style="color:red;">[Live]</span><br><span style="color:orange;">Thanesar , Haryana</span> <br> <span style="color:#bd8f4f;">Shubham Sunny</span>
    ...
    <div class="row"><!--2nd row start-->
      <div class="col-sm-4 col-md-6  content1">
        <p class="heading">  Eventsforce Abstracts</p><span style="color:green;">[Upcoming]</span> <br> <span style="color:orange;">Banglore,Karnatka</span> <br> <span style="color:#bd8f4f;">Shudhir Meena</span>
